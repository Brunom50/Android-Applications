...
//	private static final String GSR_SENSOR_NAME = "RN42-A6A1";
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		mInstance = this;
        //setContentView(R.layout.main); // broken
        
        // Set up member variables to UI Elements
        //mTextViewDataMindset = (TextView) findViewById(R.id.textViewData); // broken
        //mTextViewDataShimmerEcg = (TextView) findViewById(R.id.textViewDataShimmerEcg); // broken
        //mTextViewDataShimmerGsr = (TextView) findViewById(R.id.textViewDataShimmerGsr); // broken
        //mTextViewDataShimmerEmg = (TextView) findViewById(R.id.textViewDataShimmerEmg); // broken
...
//							series.add(mSpineChartX, 50);	
	...
	private void generateChart() {
        ...
        //LinearLayout layout = (LinearLayout) findViewById(R.id.deviceChart); // broken
    	//if (mDeviceChartView != null) {
