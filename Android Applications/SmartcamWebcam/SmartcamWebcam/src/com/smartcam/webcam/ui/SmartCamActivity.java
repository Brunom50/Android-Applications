...
public class SmartCamActivity extends Activity implements SurfaceHolder.Callback, PreviewCallback, OnSharedPreferenceChangeListener
{
    ...
    private void openCamera(SurfaceHolder holder)
    {
        ...
        AdView adView1 = (AdView) findViewById(R.id.main_ad_1);
        AdView adView2 = (AdView) findViewById(R.id.main_ad_2);
