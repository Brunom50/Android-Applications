 ...
 */
 public class getOpts {
	...
	public getOpts(String[] args) {
		...
		this.num_opts = 0;
		this.realArgs = new ArrayList<String>(args.length);
		this.analyse();
	...
	private void checkOpt(String opt) {
		try {
			...
			throw new IllegalArgumentException(""+R.string.error_arg_twice);
		}
	}
	 ...
	 */
	public ArrayList<String> getRealArgs() {	return this.realArgs;	}
